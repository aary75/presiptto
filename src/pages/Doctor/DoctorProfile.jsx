...
const DoctorProfile = () => {
   ...
   const { dToken, profileData, setProfileData, getProfileData, backenedUrl} = useContext(DoctorContext)
   ...
   const updateProfile = async () => {
    ...
    try {
       ...
       const { data } = await axios.post(backenedUrl + '/api/doctor/update-profile',updateData,{headers:{dToken}})
